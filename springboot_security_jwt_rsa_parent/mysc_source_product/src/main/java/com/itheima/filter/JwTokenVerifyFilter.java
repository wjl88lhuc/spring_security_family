...
public class JwTokenVerifyFilter extends BasicAuthenticationFilter {

    private RsaKeyProperties prop;

    public JwTokenVerifyFilter(AuthenticationManager authenticationManager, RsaKeyProperties prop) {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            //不为null，返回
            if (user != null) {
                // credentials 参数 是密码，因为我们没有将密码写到token中，所以传入为 null
